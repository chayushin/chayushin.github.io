...
document.querySelector('section article.toMyPage').addEventListener('click', ()=>{
    location.href='/mypage.html';
});
document.querySelector('section article.toHobbyPage').addEventListener('click', ()=>{
    location.href='/hobby.html';
});
document.querySelector('section article.toRoadMapPage').addEventListener('click', ()=>{
    location.href='/roadmap.html';
});
